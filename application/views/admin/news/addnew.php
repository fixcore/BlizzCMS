                        ...
                        <div class="white-box">
                            ...
                            <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input name="new_title" type="text" class="form-control" placeholder="<?= $this->lang->line('new_title'); ?>" required> </div>
                                </div>
...
<?php if(isset($_POST['button_createNew'])) {
    ...
    if ($image['type'] == 'image/jpeg')
    {
      ...
      $this->m_general->createNewADM($title, $name_new, $desc, $type);
    }
    else
