...
<!-- slides start -->
<?php if ($this->m_general->getSlides()->num_rows() > 0) { ?>
<?php foreach ($this->m_general->getSlides()->result() as $slides) { ?>
...
<div class="Pane Pane--backgroundTop Pane--full Home-gameBackgroundPane">
    <div class="Pane-backgroundContainer">
    <div style="background-image:url(<?= base_url(); ?>assets/images/backgrounds/step2)" class="Pane-background">
</div>
</div>
<div style="" class="Pane-content">
<?php if ($this->m_general->getShopTop10()->num_rows() > 0) { ?>
...
<div class="GalleryItem Home-gameGridGalleryItem">
    ...
    <div style="background-image:url(<?= base_url(); ?>assets/images/store/item1.jpg)" class="Home-gameGridTile">
</div>
</a>
...
<!-- Events START -->
<?php foreach ($this->m_general->getEventsLimitFive()->result() as $events) { ?>
