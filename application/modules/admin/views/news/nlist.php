        ...
        <div id="page-wrapper">
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box">
                            <h3 class="box-title m-b-0"><?= $this->lang->line('news_manage'); ?> - <?= $this->admin_model->getGeneralNewsSpecifyName($idlink); ?></h3>
                            ...
                            <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input name="new_title" type="text" value="<?= $this->admin_model->getGeneralNewsSpecifyName($idlink); ?>" class="form-control" placeholder="<?= $this->lang->line('new_title'); ?>" required> </div>
                                </div>

                                <div class="form-group">
                                    <label class="col-md-12"><?= $this->lang->line('new_desc'); ?></label>
                                    <div class="col-md-12">
                                        <textarea required="" name="new_description" id="adminPanelCK" rows="10" cols="80">
                                            <?= $this->admin_model->getGeneralNewsSpecifyDesc($idlink); ?>
                                        </textarea>
                                    </div>
                                </div>
                                ...
                                <button type="submit" name="button_updateNew" class="btn btn-success waves-effect waves-light m-r-10"><?= $this->lang->line('button_crea'); ?></button>
                            </form>
                        </div>
                    </div>
                </div>
