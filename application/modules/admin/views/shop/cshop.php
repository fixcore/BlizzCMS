                                    ...
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="itemname" required="" class="form-control" placeholder="<?= $this->lang->line('store_productName'); ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <!--/row-->
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" required="" class="form-control" name="priceDP" placeholder="0" value="0">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <div class="input-group-addon"><i class="ti-money"></i></div>
                                                        <input type="number" required="" class="form-control" name="priceVP" placeholder="0" value="0">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label>ITEM ID</label>
                                                    <input name="itemID" type="text" required="" class="form-control">
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" required="" name="iconName" placeholder="inv_belt_45" value="inv_belt_45" class="form-control">
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input name="imageName" required="" type="text" placeholder="image.jpg" value="image.jpg" class="form-control">
                                                </div>
                                            </div>
                                        </div>
                                        <hr>
