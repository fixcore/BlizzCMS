                            ...
                            <table id="myTable" class="table table-striped">
                                ...
                                <tbody>
                                    <?php foreach($this->admin_model->getAdminCharactersList()->result() as $chars) { ?>
                                        <tr>
                                            <td>
                                                <a href="<?= base_url(); ?>admin/clist/<?= $chars->guid ?>" title="<?= $chars->account ?>"><?= $this->m_data->getUsernameID($chars->account); ?></a>
                                            </td>
                                            <td>
                                                <a href="<?= base_url(); ?>admin/clist/<?= $chars->guid ?>" title="<?= $chars->name ?>"><?= $chars->name ?></a>
                                            </td>
                                        </tr>
                                    <?php } ?>
                                </tbody>
