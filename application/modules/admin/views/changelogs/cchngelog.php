                        ...
                        <div class="white-box">
                            ...
                            <form class="form-horizontal" method="post" action="" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input name="chang_title" type="text" class="form-control" placeholder="<?= $this->lang->line('changelog_titlec'); ?>" required> </div>
                                </div>

                                <div class="form-group">
                                    <label class="col-md-12"><?= $this->lang->line('new_desc'); ?></label>
                                    <div class="col-md-12">
                                        <textarea required="" name="chang_description" id="adminPanelCK" rows="10" cols="80">
                                        </textarea>
                                    </div>
                                </div>
