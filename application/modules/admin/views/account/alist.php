                                ...
                                <table class="table table-hover">
                                    ...
                                    <tbody>
                                        <?php foreach($this->m_general->getGeneralCharactersSpecifyAcc($idlink)->result() as $chars) { ?>
                                            <tr>
                                                <td align="center">
                                                    <a href="<?= base_url(); ?>admin/clist/<?= $chars->guid ?>"><?= $chars->guid ?></a>
                                                </td>
                                                <td>
                                                    <a href="<?= base_url(); ?>admin/clist/<?= $chars->guid; ?>"><?= $chars->name ?></a>
                                                </td>
                                                <td>
                                                    <a href="<?= base_url(); ?>admin/clist/<?= $chars->guid; ?>"><?= $this->m_general->getRaceName($chars->race); ?></a>
                                                </td>
                                                <td>
                                                    <a href="<?= base_url(); ?>admin/clist/<?= $chars->guid; ?>"><?= $this->m_general->getNameClass($chars->class); ?></a>
                                                </td>
                                                <td>
                                                    <a href="<?= base_url(); ?>admin/clist/<?= $chars->guid; ?>"><?= $chars->level ?></a>
                                                </td>
                                                <td>
                                                    <a href="<?= base_url(); ?>admin/clist/<?= $chars->guid; ?>"><?= $chars->money ?></a>
                                                </td>
                                                <td>
                                                    <a href="<?= base_url(); ?>admin/clist/<?= $chars->guid; ?>"><?= $chars->totalKills ?></a>
                                                </td>
                                            </tr>
                                        <?php } ?>
                                    </tbody>
