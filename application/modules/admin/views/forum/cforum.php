    ...
    <div id="page-wrapper">
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="white-box">
                        <h3 class="box-title m-b-0"><i class="fa fa-plus-circle fa-fw"></i><?= $this->lang->line('forum_forumCrea'); ?></h3>
                        ...
                        <form class="form-horizontal" method="post" action="">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <span class="help-block"><small>Enter a brief description of the forum.</small></span>
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <button type="submit" class="btn btn-success waves-effect waves-light m-r-10" name="button_createForum"><i class="fa fa-pencil fa-fw"></i>Create</button>
                        </form>
                    </div>
                </div>
            </div>
