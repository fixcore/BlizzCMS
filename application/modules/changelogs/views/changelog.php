...
<div class="HeroPane-content">
    ...
    <div class="Heading Heading--articleHeadline" style="color: #fff;"><i class="newspaper icon"></i> <?= $this->changelogs_model->getChanglogTitle($idlink); ?></div>
...
<div class="Pane Pane--flush Pane--adaptive Pane--backgroundTop Pane--innerBorderTop">
    <div style="background-image:url(<?= base_url(); ?>assets/images/backgrounds/generic-texture_bg.png)" class="Pane-background">
</div>
...
<div class="col-md-11">
	<div style="position: relative; text-align: right; color: #fff;">
		<?= date('d-m-Y', $this->changelogs_model->getChanglogDate($idlink)); ?>
	</div>
	<br>
</div>
...
<div class="HeroPane-content">
    ...
    <?php foreach($this->changelogs_model->getChangelogs()->result() as $changelogsList) { ?>
		...
		<a href="<?= base_url('changelogs/id/'); ?><?= $changelogsList->id ?>" data-external="false" data-article-id="1" data-analytics="Changelog" data-analytics-placement="Changelog:<?= $changelogsList->id ?> - <?= $changelogsList->title ?>" class="ArticleLink ArticleListItem-linkOverlay">
		</a>
		...
		<a href="<?= base_url('changelogs/id/'); ?><?= $changelogsList->id ?>" data-analytics="comment" data-analytics-placement="<?= $changelogsList->id ?>" data-community="<?= $changelogsList->title ?>" class="ArticleCommentLink ArticleCommentCount ArticleListItem-comments" target="_blank">
		</a>
