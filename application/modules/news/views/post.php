...
<div class="Page-container">
    ...
    <div style="background-image:url(<?= base_url(); ?>assets/images/news/<?= $this->news_model->getNewImage($idlink) ?>)" class="HeroPane-background">
</div>
...
<div class="Pane Pane--flush Pane--adaptive Pane--backgroundTop Pane--innerBorderTop">
    <div style="background-image:url(<?= base_url(); ?>assets/images/backgrounds/generic-texture_bg.jpg)" class="Pane-background">
</div>
