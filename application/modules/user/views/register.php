                ...
                <div class="Pane-content">
                    <div class="Grid row Home-storiesEventsGrid">
                        ...
                        <div class="GridItem col-md-8">
                            <!-- content START -->
                            <div style="color: #fff;">
                                <h2><?= $this->lang->line('create_acc'); ?></h2>
                                <p><?= $this->lang->line('cr_acc_des'); ?></p>
                                <form class="ui form" method="post" action="">
                                    <div class="field">
                                        <select class="ui fluid dropdown" name="reg_country">
                                    ...
                                    <div class="two fields">
                                        <div class="field">
                                            <select class="ui fluid dropdown" name="reg_dateMonthNace">
                                        ...
                                        <div class="field">
                                            <select class="ui fluid dropdown" name="reg_dateDayNace">
                                    ...
                                    <div class="two fields">
                                        <div class="field">
                                            <select class="ui fluid dropdown" name="reg_question">
                                    ...
                                    <button type="submit" name="button_register" class="ui inverted blue button"><?= $this->lang->line('button_reg'); ?></button>
                                </form>
                            </div>
                            <!-- content END -->
